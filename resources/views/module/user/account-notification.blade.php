                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        @if (Auth::user()->hasRole('influencer'))
                            <tr>
                                <td>Order Recived</td>
                                {{ Form::hidden('orderRecivedId', @$data['orderRecived']->id) }}
                                <td>
                                    {{ Form::checkbox('orderRecived[notification]', 1, @$data['orderRecived']->notification == 1 ? true : false, [
                                        'class' => 'form-check-input'
                                    ]) }}                                
                                </td>
                                <td>
                                    {{ Form::checkbox('orderRecived[email]', 1, @$data['orderRecived']->email == 1 ? true : false, [
                                        'class' => 'form-check-input'
                                    ]) }}                                
                                </td>
                                {{-- <td>
                                    {{ Form::checkbox('orderRecived[mobile]', 1, @$data['orderRecived']->mobile == 1 ? true : false, [
                                        'class' => 'form-check-input'
                                    ]) }}                                
                                </td> --}}
                            </tr>
                            <tr>
                                <td>Review Left</td>
                                {{ Form::hidden('reviewLeftId', @$data['reviewLeft']->id) }}
                                <td>
                                    {{ Form::checkbox('reviewLeft[notification]', 1, @$data['reviewLeft']->notification == 1 ? true : false, [
                                        'class' => 'form-check-input'
                                    ]) }}                                
                                </td>
                                <td>
                                    {{ Form::checkbox('reviewLeft[email]', 1, @$data['reviewLeft']->email == 1 ? true : false, [
                                        'class' => 'form-check-input'
                                    ]) }}                                
                                </td>
                                {{-- <td>
                                    {{ Form::checkbox('reviewLeft[mobile]', 1, @$data['reviewLeft']->mobile == 1 ? true : false, [
                                        'class' => 'form-check-input'
                                    ]) }}                                
                                </td> --}}
                            </tr>
